...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion Essential Studio Enterprise Edition installer.
...
8. After downloading, the Syncfusion Essential Studio Enterprise Edition installer can be unlocked using Syncfusion registered login credential.

   N> For Syncfusion trial and licensed products, there is no separate Enterprise Edition installer. Based on your account license, Syncfusion trial or licensed products will be installed via Enterprise Edition installer.
