...
8. After downloading, the Syncfusion Essential Studio web installer can be unlocked using Syncfusion registered login credential.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/common/essential-studio/installation/install-using-the-web-installer) links for step-by-step installation guidelines.	
