...
Package Generator for EJ2 Web Platforms enables you to modify the source code in Syncfusion<sup style="font-size:70%">&reg;</sup>  Essential JS2 Controls and generate the custom NPM packages.
