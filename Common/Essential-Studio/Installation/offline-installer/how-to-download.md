...
- A valid Syncfusion<sup style="font-size:70%">&reg;</sup> account (sign up for free if you do not have one).
...
1. Sign in to your Syncfusion<sup style="font-size:70%">&reg;</sup> account, then visit the [Start Trial](https://www.syncfusion.com/account/manage-trials/start-trials) page.
...
1. Sign in to your Syncfusion<sup style="font-size:70%">&reg;</sup> account. The licensed products will be available on the [License & Downloads](https://www.syncfusion.com/account/downloads) page.
