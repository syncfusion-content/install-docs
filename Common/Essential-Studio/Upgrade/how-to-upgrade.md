...
The most recent version of Syncfusion<sup style="font-size:70%">&reg;</sup> Products can be downloaded and installed by clicking on the "Latest Version: {Version}" link at the top of the Syncfusion<sup style="font-size:70%">&reg;</sup> Products Control Panel.
