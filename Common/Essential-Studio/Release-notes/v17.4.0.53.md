...
<table>
    ...
    <tr>
        ...
        <td>
            {{ '[https://ej2.syncfusion.com/documentation/release-notes/17.4.53/](https://ej2.syncfusion.com/documentation/release-notes/17.4.53/)' | markdownify }}
        </td>
    </tr>
    <tr></tr>
    <tr>
        ...
        <td>
            {{ '[https://ej2.syncfusion.com/angular/documentation/release-notes/17.4.53/](https://ej2.syncfusion.com/angular/documentation/release-notes/17.4.53/)' | markdownify }}
        </td>
    </tr>
    <tr></tr>
    <tr>
        ...
        <td>
            {{ '[https://ej2.syncfusion.com/react/documentation/release-notes/17.4.53/](https://ej2.syncfusion.com/react/documentation/release-notes/17.4.53/)' | markdownify }}
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            {{ '[https://ej2.syncfusion.com/vue/documentation/release-notes/17.4.53/](https://ej2.syncfusion.com/vue/documentation/release-notes/17.4.53/)' | markdownify }}
        </td>
    </tr>
    <tr>
	<td>
    ...
    <tr>
        ...
        <td>
            {{ '[https://help.syncfusion.com/aurelia/release-notes/v17.4.0.53](https://help.syncfusion.com/aurelia/release-notes/v17.4.0.53)' | markdownify }}
        </td>
    </tr>
    <tr>
        <td>
