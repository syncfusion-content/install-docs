...
<table>
    ...
    <tr>
        ...
        <td>
            {{ '[https://help.syncfusion.com/wpf/release-notes/v16.4.0.54](/wpf/release-notes/v16.4.0.54)' | markdownify }}
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            {{ '[https://help.syncfusion.com/aurelia/release-notes/v16.4.0.54](/aurelia/release-notes/v16.4.0.54)' | markdownify }}
        </td>
    </tr>
    <tr>
        <td>
