...
2. From the 2016 Vol 3 release(v14.3.0.49), Syncfusion provided two options to  unlock the Syncfusion setup.
   ...
   ![](Essential-Studio-Enterprise-Installer_images/Step-by-Step-Installation_img2.png)
    ...
    N> Email and Password is validated and the Platform Selection window opens.
...
4.  Click Next. Select the platforms to be installed.
