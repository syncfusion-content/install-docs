...
1. Open the Command Prompt in administrator mode and navigate to the following location.
   ...
   <b>Example:</b> C:\Program Files (x86)\Syncfusion\Essential Studio\{Platform}\21.0.1\Utilities\Project Migration\
   </div>
