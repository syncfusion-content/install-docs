...
Refer [this](https://help.syncfusion.com/windowsforms/add-syncfusion-controls) documentation link to find the required Syncfusion WinForms nuget packages for the controls you need.
