...
6. To install it in the displayed default location, click Install.
   ...
   ![](ES-Installer-for-Individual-Platform_images/Step-by-Step-Installation_img8.png)


    N> The Completed screen is displayed once the selected package is installed.

   ![](ES-Installer-for-Individual-Platform_images/Step-by-Step-Installation_img10.png)
