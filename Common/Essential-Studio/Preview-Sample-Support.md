...
description: Learn here about the Syncfusion Preview Sample support testing page for each platform, how to access preview samples, and more details.
platform: common
...
In the following example, id, pi, hasChild, and name columns from self-referential data have been mapped to value, parentValue, hasChildren, and text fields, respectively.
...
{ id: 2, pi: 1, name: 'Hot Singles' },
{ id: 3, pi: 1, name: 'Rising Artists' },
{ id: 4, pi: 1, name: 'Live Music' },
{ id: 6, pi: 1, name: 'Best of 2017 So Far' },
{ id: 7, name: 'Sales and Events', hasChild: true },
{ id: 8, pi: 7, name: '100 Albums' },
{ id: 9, pi: 7, name: 'Hip-Hop and R&B Sale' },
{ id: 10, pi: 7, name: 'CD Deals' },
{ id: 11, name: 'Categories', hasChild: true },
{ id: 12, pi: 11, name: 'Songs' },
{ id: 13, pi: 11, name: 'Bestselling Albums' },
{ id: 14, pi: 11, name: 'New Releases' },
{ id: 15, pi: 11, name: 'Bestselling Songs' },
{ id: 16, name: 'MP3 Albums', hasChild: true },
{ id: 17, pi: 16, name: 'Rock' },
{ id: 18, pi: 16, name: 'Gospel' },
{ id: 19, pi: 16, name: 'Latin Music' },
{ id: 20, pi: 16, name: 'Jazz' },
{ id: 21, name: 'More in Music', hasChild: true },
{ id: 22, pi: 21, name: 'Music Trade-In' },
{ id: 23, pi: 21, name: 'Redeem a Gift Card' },
{ id: 24, pi: 21, name: 'Band T-Shirts' },
];

let DropDownTreeObj: DropDownTree = new DropDownTree({
fields: { dataSource: localData, value: 'id', parentValue: 'pi', text: 'name', hasChildren: 'hasChild' }
});
DropDownTreeObj.appendTo('#ddltreeelement');
{% endhighlight %}
