...
Register the license key in **App.xaml.cs** constructor before InitializeComponent(). In Visual Basic, Register the licensing code in **App.xaml.vb** file before OnLaunched event.
