...
* Register the generated licence key for the platforms that require it. Please read [this](https://help.syncfusion.com/common/essential-studio/licensing/registering-license-keys) to learn how to register the licence key.
